...
function selectedState() {
    ...
    const selectValue = select.value;
        ...
        let promisseSelecteState = new Promise((resolve, reject) => {
            ...
            .catch((err) => {
                result.innerHTML = `Falha na leitura dos dados. Tente novamente mais tarde.` 
            })
    })
...
function weather(cityId) {
   ...
   return promisseSelecteCity = new Promise((resolve, reject) => {
